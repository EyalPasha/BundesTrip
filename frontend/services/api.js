...
detectApiUrl() {
  // ➊  Prefer the URL generated by generate_frontend_config.py
  if (window.apiConfig && window.apiConfig.apiUrl) {
    return window.apiConfig.apiUrl;
  }

  // ➋  Keep the local-dev fallbacks for localhost/LAN
